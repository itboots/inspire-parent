...
abstract class InternalRepository implements SimpleRepository {
    ...
    public <T> List<T> findByQuery(String queryString) {
        return this.findByQuery(queryString, (Map<String, Object>) null);
    }
    ...
    public <T> Slice<T> sliceByQuery(String queryString, Pageable pageable) {
        return this.sliceByQuery(queryString, (Map<String, Object>) null, pageable);
    }
    ...
    public <T> Page<T> findByQuery(String queryString, Pageable pageable) {
        return this.findByQuery(queryString, (Map<String, Object>) null, pageable);
    }
    ...
    public <T> Slice<T> sliceByQuery(String queryString, Map<String, Object> params, Pageable pageable) {
        return (Slice<T>) (pageable == null
                ...
                : this.readSlice(queryString, params, pageable));
    }
    ...
    public <T> Page<T> findByQuery(String queryString, Map<String, Object> params, Pageable pageable) {
        return (Page<T>) (pageable == null
                ...
                : this.readPage(queryString, params, pageable));
    }
    ...
    @Override
    @Transactional(rollbackFor = Throwable.class)
    public <T extends Persistable> List<T> save(Iterable<T> entities) {
    ...
    @Transactional(rollbackFor = Throwable.class)
    protected <T extends Persistable> T saveInternal(T entity) {
        prepare(entity);
...
//        if (entity instanceof StringAuditable) {
//            ((StringAuditable) entity).audit(StringAuditable.DEFAULT_AUDITOR);
//        }
    }
